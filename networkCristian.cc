...
int main (int argc, char *argv[]) {
  ...
  // Variar par trançado de 5Mbps a 100Mbps
 ...
 // em->SetAttribute ("ErrorRate", DoubleValue (0.1));
  ...
  for ( uint32_t i = 0; i < nWifi; i++ ){
    if(i != 0){     
      clientApps.Add(echoClient.Install (wifiStaNodes2.Get (i)));      
  ...
  if (tracing == true){
      ...
      //csma.EnablePcap ("networkOnetExampleCsma", csmaDevices.Get (0), true);      
  }
  ...
  std::string fileMetric ="./scratch/networkCristian.dat";
